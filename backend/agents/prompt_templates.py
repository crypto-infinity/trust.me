...
VERIFIER_PROMPT = PromptTemplate(
    ...
    template=(
        ...
        "During the validation process, IGNORE any non-informative text "
        "snippet such as redirect messages, code snippets, parsed website "
        "fragments, or similar irrelevant content. Concentrate only on "
