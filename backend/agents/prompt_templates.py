...
VERIFIER_PROMPT = PromptTemplate(
    ...
    template=(
        ...
        "{text_chunks}. "
        "Assess whether the information is consistent, reliable, and free of "
        "contradictions. For this assestment use only INFORMATIONAL excerpt"
        "(contains useful data, facts, relevant information)."
        "Ignore all SERVICE excerpt (navigation phrases, privacy, cookie"
        "notices, advertisements, banners, app prompts, disclaimers, etc.)."
        ...
        "- suggested_retry: a search engine query to clarify critical points"
